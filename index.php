        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-sm-4 offset-md-1 py-4 text-right">
                    ...
                    <p class="text-muted">Log in so you can take advantage with hostels' room prices.</p>
                    <?php } ?>
                </div>
            </div>
        </div>
    ...
    <div class="navbar navbar-dark bg-dark box-shadow">
        <div class="container d-flex justify-content-between">
            <a href="#" class="navbar-brand d-flex align-items-center">
                ...
                <strong>Lab-Hostel Booking</strong>
            </a>
...
<main role="main">
    ...
    <section class="jumbotron text-center">
        <div class="container pt-lg-5 pl-5 px-5">
            <h1 class="display-3">All types of hostels and homestels</h1>
            <p class="lead text-muted">Book your accomodation for the academic year or semester with us now.</p>
            <p>
                <?php if ($isSessionExists) { ?>
    ...
    <div class="container">
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            ...
            <p class="lead">Affordable and Extra-Ordinaire hostels with quality services.</p>
        </div>
    </div>
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Adwoa Dufie</h5>
                        </div>
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                The ultimate sanctuary to recharge the senses, the beautifully-appointed 24sqm Deluxe Room exudes sheer sophistication and elegance. Located on the higher floors, each Deluxe Room is characterised by elevated ceilings and full length bay windows, transforming your living space into an atmospheric abode.
                            </p>
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted">GHS2,500 / Academic Year</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Exorsia</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php } ?>
                                <small class="text-muted">GHS2,700 / Academic Year</small>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="card mb-4 box-shadow">
                        <div class="card-header">
                            <h5 class="my-0 font-weight-normal">Oye Inn</h5>
                        </div>
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php } ?>
                                <small class="text-muted">GHS5,500 / Academic Year</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <small class="text-muted">GHS3,250 / Academic Year</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php } ?>
                                <small class="text-muted">GHS4000 / Academic Year</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card mb-4 box-shadow">
                        ...
                        <div class="card-body">
                            ...
                            <div class="d-flex justify-content-between align-items-center">
                                ...
                                <?php } ?>
                                <small class="text-muted">GHS4,500 / Academic Year</small>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <?php if ($isSessionExists == 1 && $isAdmin[1] == "false") { ?>
                        <form role="form" autocomplete="off" method="post" id="multiStepRsvnForm">
                                ...
                                <div class="form-group row align-items-center">
                                    ...
                                    <div class="col-sm-9">
                                        <select required class="custom-select mr-sm-2"  name="roomType">
                                            ...
                                            <option value="<?php echo \models\RequirementEnum::DOUBLE; ?>">Two-In room</option>
                                            <option value="<?php echo \models\RequirementEnum::SINGLE; ?>">One-In room</option>
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group row align-items-center">
                            ...
                            <div class="rsvnTab">
                                ...
                                <div class="form-group row align-items-center">
                                    <label class="col-sm-3 col-form-label font-weight-bold" for="numNights"><span class="numNightsTxt">2</span> Semesters </label>
                                    <div class="col-sm-9">
                                        GHS<span class="roomPricePerNightTxt">69.63</span> avg. / semester
                                    </div>
